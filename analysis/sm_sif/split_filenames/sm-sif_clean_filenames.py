...
import sys
if len(sys.argv) != 3:
    print("Usage: sm-sif_clean_filenames.py <root path to search> <textfile to write to>")
    sys.exit()
    
#dataroot = "/home/ckirsch/git/cosmics/datasets/sif_fits"  # all the SIF files are here (simlink)
dataroot = sys.argv[1]
#outfilename = "sm_abspaths_clean.txt"
